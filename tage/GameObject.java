...
public class GameObject
{
	...
	*/
	...
	/** Rotates the game object around the V vector. */
	public void yaw(float keyValue, float deltaTime) {
		Matrix4f rotAroundAvatarUp, oldRotation, newRotation;
		Vector4f oldUp;
		...
		if(keyValue < -.2) {
			rotAroundAvatarUp = new Matrix4f().rotation(deltaTime, new Vector3f(0.0f, 1.0f, 0.0f));
		}
		else {
		
			rotAroundAvatarUp = new Matrix4f().rotation(-1.0f * deltaTime, new Vector3f(0.0f, 1.0f, 0.0f));
		}
	...
	/** Rotates the game object around the U vector. */
	public void pitch(float keyValue, float deltaTime) {
		Matrix4f rotAroundAvatarRight, oldRotation, newRotation;
		Vector4f oldRight;
		...
		if(keyValue < -.2) {
			rotAroundAvatarRight = new Matrix4f().rotation(-1.0f*deltaTime, new Vector3f(1.0f, 0.0f, 0.0f));
		}
		else {
			rotAroundAvatarRight = new Matrix4f().rotation(deltaTime, new Vector3f(1.0f, 0.0f, 0.0f));
		}
	...
	/** Move the game object along the N vector.  */
	public void move(float keyValue, float deltaTime) {
		...
		if(keyValue < -.2) {
			fwdDirection.mul(deltaTime);
		}
		else {
			fwdDirection.mul(-1.0f * deltaTime);
		}
