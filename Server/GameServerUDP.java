...
public class GameServerUDP extends GameConnectionServer<UUID> 
{
	...
	int maxPlayers = 4;
	int numPlayers = 0;
	private Vector3f positionOne = new Vector3f(0.0f, 0.0f, 1.0f);
	private Vector3f positionTwo = new Vector3f(0.0f, 0.0f, 3.0f);
	private Vector3f positionThree = new Vector3f(0.0f, 0.0f, 5.0f);
	private Vector3f positionFour = new Vector3f(0.0f, 0.0f, 7.0f);
	private Vector<Vector3f> playerPositions = new Vector<Vector3f>();


	public GameServerUDP(int localPort) throws IOException 
	{	super(localPort, ProtocolType.UDP);
		playerPositions.add(positionOne);
		playerPositions.add(positionTwo);
		playerPositions.add(positionThree);
		playerPositions.add(positionFour);
	}
	...
	{	try 
		{	System.out.println("trying to confirm join");
			...
			if(success && numPlayers < maxPlayers)
			{
				message += "success";
				Vector3f position = playerPositions.get(numPlayers);
				message += "," + position.x();
				message += "," + position.y();
				message += "," + position.z();
				numPlayers++;
